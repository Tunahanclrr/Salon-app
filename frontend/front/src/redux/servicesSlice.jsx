...
export const addService = createAsyncThunk(
  ...
  async (service, { rejectWithValue }) => {
    ...
    try {
      const { data } = await axios.post('http://localhost:4000/api/services', service);
...
export const editService = createAsyncThunk(
  ...
  async ({ id, data }, { rejectWithValue }) => {
    try {
      const { data: response } = await axios.put(`http://localhost:4000/api/services/${id}`, data);
      return response;
    } catch (err) {
...
export const deleteService = createAsyncThunk(
  ...
  async (id, { rejectWithValue }) => {
    try {
      ...
      const response = await axios.delete(`http://localhost:4000/api/services/${id}`);
